...
class RecipesIngredients(db.Model):
    ...
    recipe = Column(Integer, ForeignKey('recipes.id', ondelete="CASCADE"),
                    nullable=False)
...
class RecipesTags(db.Model):
    ...
    id = Column(Integer, primary_key=True, nullable=False)
    recipe = Column(Integer, ForeignKey('tags.id', ondelete="CASCADE"),
                    nullable=False)
    tag = Column(Integer, ForeignKey('recipes.id', ondelete="CASCADE"),
                 nullable=False)
...
class RecipesInstructions(db.Model):
    ...
    id = Column(Integer, primary_key=True, nullable=False)
    recipe = Column(Integer, ForeignKey('instructions.id', ondelete="CASCADE"),
                    nullable=False)
    instruction = Column(Integer, ForeignKey('recipes.id', ondelete="CASCADE"),
                         nullable=False)
...
class RecipesImages(db.Model):
    ...
    id = Column(Integer, primary_key=True, nullable=False)
    recipe = Column(Integer, ForeignKey('images.id', ondelete="CASCADE"),
                    nullable=False)
    image = Column(Integer, ForeignKey('recipes.id', ondelete="CASCADE"),
                   nullable=False)
...
class RecipesPlanning(db.Model):
    ...
    id = Column(Integer, primary_key=True, nullable=False)
    recipe = Column(Integer, ForeignKey('planning.id', ondelete="CASCADE"),
                    nullable=False)
    planning = Column(Integer, ForeignKey('recipes.id', ondelete="CASCADE"),
                      nullable=False)
...
class RecipesNutrition(db.Model):
    ...
    id = Column(Integer, primary_key=True, nullable=False)
    recipe = Column(Integer, ForeignKey('nutrition.id', ondelete="CASCADE"),
                    nullable=False)
    nutrition = Column(Integer, ForeignKey('recipes.id', ondelete="CASCADE"),
                       nullable=False)
...
class Recipes(db.Model):
    ...
    ingredients = relationship("Ingredients", secondary="RecipesIngredients",
                               backref="recipes")
    ...
    planning = relationship("Planning", secondary="RecipesPlanning",
                            backref="recipes")
    nutrition = relationship("Nutrition", secondary="RecipesNutrition",
                             backref=backref("nutrition",
                                             cascade="all, delete"))
    instructions = relationship("Instruction", secondary="RecipesInstructions",
                                backref="recipes")
...
class Ingredients(db.Model):
    ...
    def as_schema(self) -> schema.Ingredient:
        return schema.Ingredient(ingredient_id=self.id,
                                 raw_string=self.raw_string, name=self.name,
...
class Plan(db.Model):
    ...
    def as_schema(self) -> schema.Plan:
        return schema.Plan(planning_id=self.id, prep_time=self.prep_time,
...
class Nutrition(db.Model):
    ...
    def as_schema(self) -> schema.Nutrition:
        return schema.Nutrition(nutrition_id=self.id, energy=self.energy,
                                fat=self.fat,
...
class Products(db.Model):
    ...
    def as_schema(self) -> schema.Product:
        return schema.Product(product_id=self.id, name=self.name,
...
class Instructions(db.Model):
    ...
    def as_schema(self) -> schema.Instruction:
        return schema.Instruction(instruction_id=self.id,
